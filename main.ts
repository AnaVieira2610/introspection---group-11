...
function Starting () {
    ...
    timevalue = textsprite.create("INTROSPECTION", 0, 10)
    timevalue.setMaxFontHeight(11)
    ...
    timer.after(750, function () {
        ...
        timer.after(1000, function () {
            timer.background(function () {
                timevalue.destroy(effects.ashes, 200)
            })
        })
    })
}
...
blockMenu.onMenuOptionSelected(function (option, index) {
    if (option == "How to play") {
        ...
        game.setDialogFrame(img`
            ...
            b4bb4bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
            `)
        game.showLongText("You are playing as David the alien. And you are playing hide and seek with your cosmic friends. The point of the game is to find the fruits their hid, as well as your friend within the time limit.", DialogLayout.Center)
    }
})
